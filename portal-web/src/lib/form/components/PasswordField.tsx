/**
 * PasswordField Component - Form Composition Layer
 *
 * Pre-bound password input that automatically wires to TanStack Form field context.
 * Includes show/hide toggle and automatic error translation.
 *
 * Usage within form:
 * ```tsx
