...
func runWeb(cmd *cobra.Command, args []string) {
	...
	assetDomain := asset.NewDomain(postgres, atomicProcess, cache, storeDomain)
	customerDomain := customer.NewDomain(postgres, atomicProcess, cache, storeDomain)
	expenseDomain := expense.NewDomain(postgres, atomicProcess, cache, storeDomain)
	inventoryDomain := inventory.NewDomain(postgres, atomicProcess, cache, storeDomain)
