...
description: Billing SSOT — Plans, Subscriptions, Invoices, Webhooks (Backend + Portal-Web guidance)applyTo: "backend/internal/domain/billing/**,portal-web/src/features/billing/**"---
