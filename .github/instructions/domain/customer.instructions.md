...
applyTo: "backend/internal/domain/customer/**,portal-web/src/features/customers/**"
---
...
- **ProblemDetails errors:** errors are returned as RFC7807 ProblemDetails via the shared response layer (see `.github/instructions/frontend/_general/http-client.instructions.md` for portal handling patterns).
...
- Use existing form system + UI primitives (see `.github/instructions/frontend/_general/forms.instructions.md` and `.github/instructions/frontend/_general/ui-patterns.instructions.md`).
