...
applyTo: "backend/internal/domain/asset/**,portal-web/src/lib/upload/**,portal-web/src/components/form/FileInput*"
---
...
- Related Frontend: frontend/\_general/forms.instructions.md (FileUploadField, ImageUploadField), frontend/\_general/http-client.instructions.md (HTTP client)
...
- **frontend/\_general/http-client.instructions.md** — HTTP client patterns for upload API calls
- **backend-core.instructions.md** — Backend architecture for asset storage and GC
- **frontend/\_general/ui-patterns.instructions.md** — Progress indicators, error states for uploads
