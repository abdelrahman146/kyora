...
- Backend peers: `backend/_general/errors.instructions.md` (Go-specific error patterns), `backend/_general/api-contracts.instructions.md`
- Portal peers: `frontend/_general/http-client.instructions.md`, `frontend/_general/forms.instructions.md`
