...
- **Errors are RFC7807 ProblemDetails:** rely on ProblemDetails typing and translation behavior (see `.github/instructions/ky.instructions.md`).
...
- Keep UI Arabic/RTL-first and use existing UI primitives (see `.github/instructions/portal-web-ui-guidelines.instructions.md` and `.github/instructions/ui-implementation.instructions.md`).
